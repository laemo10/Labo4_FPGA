...
set_property PACKAGE_PIN Y17 [get_ports {vitesse_vehicule_0[7]}]
set_property PACKAGE_PIN T17 [get_ports {vitesse_vehicule_0[6]}]
set_property PACKAGE_PIN U17 [get_ports {vitesse_vehicule_0[5]}]
set_property PACKAGE_PIN V13 [get_ports {vitesse_vehicule_0[4]}]
set_property PACKAGE_PIN H15 [get_ports {vitesse_vehicule_0[3]}]
set_property PACKAGE_PIN J15 [get_ports {vitesse_vehicule_0[2]}]
set_property PACKAGE_PIN W16 [get_ports {vitesse_vehicule_0[1]}]
set_property PACKAGE_PIN V12 [get_ports {vitesse_vehicule_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vitesse_vehicule_0[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vitesse_vehicule_0[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vitesse_vehicule_0[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vitesse_vehicule_0[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vitesse_vehicule_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vitesse_vehicule_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vitesse_vehicule_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vitesse_vehicule_0[0]}]
